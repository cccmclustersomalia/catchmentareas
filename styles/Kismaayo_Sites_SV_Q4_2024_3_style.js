...
var style_Kismaayo_Sites_SV_Q4_2024_3 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (size == 1) { // If cluster has one feature
        ...
        if (feature.get("\"Neighbourhood\"+ ' - ' + \"IDP Site\" ") !== null) {
            labelText = String(feature.get("\"Neighbourhood\"+ ' - ' + \"IDP Site\" "));
        }
